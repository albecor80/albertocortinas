<script>
    ...
    import { ages } from '$lib/data/hotels_country';
    ...
    onMount(async () => {
        try {
            ...
            const colorScale = d3.scaleLinear()
                ...
                .range(["#fff", "#16795f"]); // Replace with your custom color range
            ...
            svgElement.selectAll('path')
                ...
                .on('mouseover', function (event, d) {
                    ...
                    tooltip
                        ...
                        .style("opacity", 1)
                        .html(`${countryName}<br/>Age: ${age ? age + " %" : "No data"}`);  // Display country name and age
                })
